  ...
  return (
    <>
          ...
          <Card className="bg-white dark:bg-slate-900 shadow-md border-0 overflow-hidden">
            <CardContent className="p-2 md:p-4 relative">
              ...
              <div className="text-center space-y-0.5 md:space-y-1 mb-2 md:mb-3">
                ...
                <div className="flex justify-center items-center space-x-1 md:space-x-1.5 mt-0.5 md:mt-1">
                  <Badge className="bg-purple-100 text-purple-700 dark:bg-purple-900 dark:text-purple-300 border-0 px-1.5 md:px-2 py-0 md:py-0.5 text-xs">
                    <Zap className="w-2 h-2 md:w-2.5 md:h-2.5 mr-0.5" />
                    Expert
                  </Badge>
                  <span className="text-slate-400 text-xs">+{Math.max(0, (profile.stats?.wins || 0) - 1)}</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-1.5 md:gap-2 mb-2 md:mb-3">
                <div className="text-center">
                  <div className="flex items-center justify-center w-7 h-7 md:w-8 md:h-8 bg-amber-100 dark:bg-amber-900/30 rounded-full mx-auto mb-0.5 md:mb-1">
                    <Star className="w-3 h-3 md:w-4 md:h-4 text-amber-600 dark:text-amber-400" />
                  </div>
          ...
          <form onSubmit={handleChallenge} className="space-y-2">
            ...
            <div className="flex space-x-2 pt-2">
              ...
              <Button 
                ...
                className="flex-1 h-8 px-3 text-sm rounded-xl shadow-sm"
      ...
      <Dialog open={showTipModal} onOpenChange={setShowTipModal}>
        <DialogContent className="sm:max-w-sm border-0 shadow-md">
          ...
          <form onSubmit={handleTip} className="space-y-5">
            ...
            <div className="flex space-x-3 pt-4">
              ...
              <Button 
                ...
                className="flex-1 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl shadow-sm"
              >
