    ...
    const challengesWithCounts = await Promise.all(
      results.map(async (r: any) => {
        ...
        return {
          ...
          earlyBirdSlots: challenge.earlyBirdSlots,
          earlyBirdBonus: challenge.earlyBirdBonus,
          streakBonusEnabled: challenge.streakBonusEnabled,
          convictionBonusEnabled: challenge.convictionBonusEnabled,
          firstTimeBonusEnabled: challenge.firstTimeBonusEnabled,
          socialTagBonus: challenge.socialTagBonus,
        };
      })
    );
